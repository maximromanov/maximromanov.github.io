...
gold hairline for frames and rules (the *jadwal* of a manuscript page), Libre Baskerville for text, Calibri (Carlito as the self-hosted stand-in) for
interface text, Consolas (Inconsolata as the self-hosted stand-in) for labels, Amiri for Arabic (the name on the home page, the nav
